...
export const metadata: Metadata = {
  ...
  description: "Learn about Serenity, Nigeria's trusted provider of cleaning, laundry, and home repair. Discover our mission, values, and commitment to quality home care.",
  keywords: [
